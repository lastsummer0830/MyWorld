...
export const COLOR = {
  ...
  // ★ 2026-08-01 실측: 순백(#F6F4EF)은 이 씬의 광량(합 ≈ π)에서 밝은 면이 246/255까지 올라
  //   **형태가 통째로 날아간다.** 흰 개는 팔레트에서 한 단계 낮춰 잡아야 화면에서 흰 개로 보인다.
  dogWhite: '#E8E4D8', //  주조색 — 가슴 갈기·다리·배·꼬리
  // ★ 무늬 3색은 팔레트에서 **차갑게(파랑 쪽으로)** 잡는다. 해가 금빛(#FFD190)이라
  //   중성 회색을 넣으면 화면에서 누런 흙빛으로 뜬다 — 5차 렌더에서 그렇게 나왔다.
  // ★ 2026-08-01 3차: 사진의 블루멀은 **밝은 은회색이 바탕**이고 검정은 군데군데 박힌 얼룩이다.
  //   2차의 #7E8B99 + 넓은 얼룩 조합은 화면에서 등에 감색 조끼를 입힌 것처럼 나왔다.
  dogSilver: '#9AA5B1', //  등판 은회색 — 바탕이므로 밝게
  dogMerle: '#3A4350', //  등판의 검은 얼룩
  dogCharcoal: '#23272F', //  얼굴·귀의 검정
  dogTan: '#C08A4E', //  눈두덩·볼의 황갈색 포인트
  dogCream: '#F2E3C8', //  (구) 발바닥 등 따뜻한 소품에만 남겨 둔다
  dogBrown: '#B98A5F',
  dogSlate: '#8C93A6',
  dogInk: '#24262B', //  코·눈동자 — 사진의 코는 거의 검정이다
  eyeBlue: '#7FA9C9', //  오드아이의 파란 눈 — 강아지의 **왼쪽**
  dogAmber: '#6B4A32', //  오드아이의 반대쪽 — 사진의 오른눈은 검정이 아니라 짙은 호박색이다
